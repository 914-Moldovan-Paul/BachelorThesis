        ...
        <div className="bg-white shadow">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between py-4 h-2/4">
                    <div>Ideal Automotive</div>
                    <div className="hidden sm:flex sm:items-center">
                        <Link to="/cars" className="text-gray-800 text-sm font-semibold hover:text-blue-600 mr-4">Cars</Link>
                        <Link to="/myads" className="text-gray-800 text-sm font-semibold hover:text-blue-600 mr-4">My Ads</Link>
                    </div>
                    {isAuthenticated ? (
                        <div className="hidden sm:flex sm:items-center">
                ...
                <div className="block sm:hidden bg-white border-t-2 py-2">
                    <div className="flex flex-col">
                        ...
                        <Link to="/myads" className="text-gray-800 text-sm font-semibold hover:text-blue-600 mb-1">My Ads</Link>
                        {isAuthenticated ? (
                            <>
