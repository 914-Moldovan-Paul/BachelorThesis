...
const SearchBox = ({ onSubmit }) => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10">
      ...
      />
      <button
        className="mt-4 px-4 py-2 bg-blue-600 font-semibold text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50"
